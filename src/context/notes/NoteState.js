...
const getNotes=async ()=>{
  ...
  const response = await fetch(`${host}/api/notes/fetchallnotes`, {
    ...
    headers: {
      ...
      'auth-token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjJiMjkwMmZmODI2MTczMjA3NzUxNDAxIn0sImlhdCI6MTY1NTkxMzg3NX0.lZolCKFzRWM_Pi9vWkCAOtlBCdFocU0vboJWlOTee5o'
    },
