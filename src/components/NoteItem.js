    ...
    <div className="col-md-3 my-2">
      <div className="card ">
        <div key={Math.random()} className="card-body  ">
          <h5 className="card-title mx-2">{note.title}<i className="fa-solid fa-trash-can mx-2" onClick={()=>{deleteNote(note._id)}}></i><i className="fa-solid fa-pen-to-square mx-2"></i></h5>
